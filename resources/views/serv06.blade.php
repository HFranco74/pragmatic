        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="services-list">
              ...
              <a href="{{ route('serv6') }}" class="active">Diagnóstico</a>
            </div>
          </div>

          <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
            <img src="assets/img/diagnostico.jpg" width="400" alt="" class="img-fluid services-img">
            <h3>Diagnóstico</h3>
                <p>
                  DIAGNÓSTICO DE SU ORGANIZACIÓN COMO SISTEMA
                </p>
                <br/>
                <p>
                  Quieres entender el nivel de integración para; ¿Generar valor a clientes internos y externos?, ¿Acelerar los resultados para lograr las metas a corto y largo plazo?, ¿Cómo mejorar la productividad de la operación interna?
                </p>
                ...
                <p>
                  <a href="{{ route('home') }}#contact" >Contáctanos</a> y con gusto te apoyamos.
                </p>
          </div>
        </div>
      </div>
