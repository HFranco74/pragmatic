        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            <article>
              ...
              <p class="post-category">{{ $post->categoria->categoria }}</p>

              <h2 class="title">
                <a href="{{ route('blog-details') }}">{{ $post['titulo'] }}</a>
              </h2>

              <div class="d-flex align-items-center">
                {{-- <img src="{{ $post['imagen'] }}"  class="img-fluid post-author-img flex-shrink-0"> --}}
                <div class="post-meta">
                  <p class="post-author">{{  $post->user->name }}</p>
                  <p class="post-date">
                    <time datetime="{{ $post['created_at'] }}">{{ date_format(date_create($post['created_at']), "d-m-Y H:i:s") }}</time>
                  </p>
                </div>
              </div>
